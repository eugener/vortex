...
impl ThemeFile {
    ...
    fn resolve(self) -> Result<Theme, String> {
        ...
        Ok(Theme {
            ...
            search_match: slot("search_match", self.search_match, base.search_match)?,
            search_current: slot("search_current", self.search_current, base.search_current)?,
            ...
            palette_dim: slot("palette_dim", self.palette_dim, base.palette_dim)?,
